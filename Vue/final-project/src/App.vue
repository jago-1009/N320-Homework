...
<template>
  <div v-if="isSessionHome === true">
    <NavBar
      @toggle-home="toggleHome"
      @toggle-back="toggleBack"
      :mySessions="mySessions"
      :isSessionHome="isSessionHome"
    ></NavBar>

    <ConferenceInfo
      @add-to-list = "addToList"
      v-for="data in sessions"
      :key="data"
      :desc="data.desc"
      :presenter="data.presenter"
      :sDay="data.sDay"
      :sTime="timeFilter(data.sTime)"
    ></ConferenceInfo>
  </div>
  <div v-if="isSessionHome === false">
    <NavBar
      @toggle-home="toggleHome"
      @toggle-back="toggleBack"
      :mySessions="mySessions"
